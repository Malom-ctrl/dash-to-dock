...
var DockDash = GObject.registerClass({
    ...
    _init(monitorIndex) {
        ...
        this._signalsHandler.addWithLabel(Symbol('scroll-on-showappsbutton-switch-workspace'),
                this._showAppsIcon, 'scroll-event', (_, e) => switchWorkspace(e));
        ...
        const switchWorkspace = event => {
            ...
            let prevDirection = Meta.MotionDirection.UP;
            let nextDirection = Meta.MotionDirection.DOWN;
            ...
            case Clutter.ScrollDirection.SMOOTH:
                ...
                direction = dy < 0 ? prevDirection : dy > 0 ? nextDirection : null;
                break;
            }
            ...
            let targetWorkspace = global.workspace_manager.get_active_workspace().get_neighbor(direction)
